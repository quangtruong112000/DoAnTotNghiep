...
using AppBanThuoc.ObjectDetection.YoloParser;
using AppBanThuoc.ObjectDetection.DataStructures;
...
namespace AppBanThuoc.ObjectDetection
{
    ...
    public class ObjectDetection
    {
        ...
        static string assetsPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "assets");
